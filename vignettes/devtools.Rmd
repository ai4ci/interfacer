...
in the documentation where they will be expanded to their definition. This can 
be combined to document return values using the `roxygen2` `@ireturn` tag that 
picks up format definitions from the call to `ireturn(value, spec)` in the 
function body.
...
#' input and output formats defined above.
#' 
#' @iparam df An input dataframe
